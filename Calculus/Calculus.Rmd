...
- $f : \begin{cases} \mathbb{R}_+ & \to & \mathbb{R} \\ x & \mapsto & \sqrt{x} \end{cases}$ est pas une application.
...
<b>Remarques</b>
Les bijections ont un intérêt particulier en mathématiques, elles permettent sur des éléments de $A$ (élèves scolarisés à Paris Descartes) ou $B$ (numéro d'étudiant) indifféremment et <b>sans perte d'information</b>. En particulier, il y <em>autant</em> d'éléments dans $A$ que dans $B$ et $f$ (respectivement $f^{-1}$) fournit une façon non ambigüe de passer de $A$ à $B$ (de $B$ à $A$)

## Exercice récapitulatifs (I)
