...
\end{array}
$$
Le but du jeu est bien sûr d'identifier la **bonne** fonction $u(x)$ qui permet de se ramener au tableau précédent. 

## Exercice (I)

Trouver une primitive des fonctions (de $x$) suivantes:
$$
\begin{align*}
...
En utilisant le théorème fondamental, calculer les intégrales suivantes:
$$
\begin{align*}
...
$$
\int_x^z f(t)dt = \int_x^y f(t)dt + \int_y^z g(t)dt
$$
</div>
...
C'est l'équivalent du théorème des acroisseements finis, reformulés avec des intégrales. 
...
En pratique, on utilise souvent la formule "de la droite vers la gauche".
