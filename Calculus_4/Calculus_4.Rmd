...
$$
La méthode à suivre pour faire un DL est donc <alert>systématiques</alert>
...
$$
\begin{align}
DL_4(0) \; \text{ de } \; \frac{x}{\sin(x)} & & DL_2(0) \; \text{ de } \; \ln(a^x + b^x)  \\
DL_4(0) \; \text{ de } \; \frac{1}{\cos(x)} & & DL_4(\pi/2) \; \text{ de } \; \sin(x)^{\sin(x)}  \\
DL_2(\pi/4) \; \text{ de } \; \sqrt{\tan(x)} & & DL_3(0) \; \text{ de } \; \sqrt{1 + \sqrt{1 - x}}  \\
DL_5(0) \; \text{ de } \; e^{\cos(x)} & & DL_3(0) \; \text{ de } \; x\sqrt{\frac{1+x}{1-x}}  \\
...
\lim_{x \to 1} \frac{\ln(x)}{x^2 - 1} & & \lim_{x \to 1} \frac{\ln(x)\tan(\pi x /4)}{(x - 1)^2} \\
